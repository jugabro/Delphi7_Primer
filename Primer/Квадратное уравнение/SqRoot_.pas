...
procedure SqRoot( a,b,c : real; var x1, x2 : real; var ok : boolean);
    { a,b,c - коэффициенты уравнени€
      x1,x2 - корни уравнени€
    ...
    begin
        ...
        if d < 0
             then
               ok := False  // уравнение не имеет решени€
        else
            begin
                ok := True;
                x1 := (-b + Sqrt(d)) / (2*a);
